...
assert clean_data_and_count_lights(["turn on 0,0 through 999,999"],update_lights) == 1000000
assert clean_data_and_count_lights(["toggle 0,0 through 999,0"],update_lights) == 1000
assert clean_data_and_count_lights(["turn on 0,0 through 999,999","turn off 499,499 through 500,500"],update_lights) == 999996
...
assert clean_data_and_count_lights(["turn on 0,0 through 0,0","toggle 0,0 through 999,999"],update_lights_2) == 2000001
